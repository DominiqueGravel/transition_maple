...
ENV = expand.grid(TP = seq(-1,5,0.01), PP = seq(0.75,1.5,0.001))
TP = ENV$TP
PP = ENV$PP
...
title(title,cex=2)
legend("center",legend = c("C Wins","D Wins","Coexistence"),fill = grey(c(0:2)/2),bty = "n",horiz = TRUE,cex = 1)
par(mar=c(5,5,0,2))
